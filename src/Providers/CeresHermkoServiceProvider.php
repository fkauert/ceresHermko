    ...
    public function boot(Twig $twig, Dispatcher $eventDispatcher, ConfigRepository $config)
    {
        ...
        $eventDispatcher->listen('IO.tpl.*', function (TemplateContainer $templateContainer, $templateData = []) {
            if ( !$templateContainer->hasTemplate() )
            {
                ...
                $templateContainer->setTemplate('CeresHermko::' . $templateName);
            }
        ...
        $eventDispatcher->listen( 'IO.ResultFields.*', function(ResultFieldTemplate $templateContainer) {
            $templateContainer->setTemplates([
                ResultFieldTemplate::TEMPLATE_LIST_ITEM     => 'CeresHermko::ResultFields.ListItem',
                ResultFieldTemplate::TEMPLATE_SINGLE_ITEM   => 'CeresHermko::ResultFields.SingleItem',
                ResultFieldTemplate::TEMPLATE_BASKET_ITEM   => 'CeresHermko::ResultFields.BasketItem'
            ]);
        }, self::EVENT_LISTENER_PRIORITY);
